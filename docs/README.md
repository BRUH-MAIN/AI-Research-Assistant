...
### API Documentation
- **[API_ENDPOINTS.md](./API_ENDPOINTS.md)** - Comprehensive API reference for all endpoints
...
- **[supabase.md](./supabase.md)** - Supabase integration documentation
...
- **[FRONTEND_SERVICES_README.md](./FRONTEND_SERVICES_README.md)** - API services documentation

### Project Information
- **[instruction.md](./instruction.md)** - Project instructions
- **[README_PAPER_SEARCH.md](./README_PAPER_SEARCH.md)** - Paper search functionality
...
All documentation has been centralized in this `/docs` folder for better organization and easier maintenance. Files were moved from various locations including:
- Root directory
- `backend/` folder
- `backend/app/` folder
- `frontend/` folder
- `frontend/src/app/services/` folder

This centralization makes it easier to:
- Find relevant documentation quickly
- Maintain consistent documentation standards
- Avoid duplication across the project
